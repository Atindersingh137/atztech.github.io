							...
							<div class="col-xs-12">
								<form id="login-form" method="post">
									...
									<div class="contact-btn">
										<button type="button" class="cr__btn" onclick="update_profile()" id="btn_submit">Update</button>
						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form method="post" id="frmPassword">
									...
									<div class="contact-btn">
										<button type="button" class="cr__btn" onclick="update_password()" id="btn_update_password">Update</button>
